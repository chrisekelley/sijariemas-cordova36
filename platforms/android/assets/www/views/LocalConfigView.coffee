    ...
    @$el.html "
      <form id='local-config'>
        ...
        <select name='coconut-cloud'>
          ...
          <option value='http://192.168.16.101:5984/coconut-central-sijariemas-rep-live/'>192.168.16.101 - replicate to live server</option>
          <option value='http://localhost:5984/coconut-central-sijariemas-rep-local/'>localhost:5984 - replicate to local server</option>
          <option value='http://localhost:5984/coconut-central-sijariemas-rep-live/'>localhost:5984 - replicate to live server</option>
        </select>
                      ...
                      success: ->
                          ...
                          repFromOpts =
                              success: ->
                                ...
                                Coconut.syncView.sync.replicateToServer(repToOpts, completeExtra)
                              error: (obj, msg)->
                                $('#message').append "Replication Error:" + msg + "<br/>"
                          Coconut.syncView.sync.replicateFromServer(repFromOpts, completeExtra)
                      error: (obj, msg)->
